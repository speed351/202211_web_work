			...
			<form action="signup.jsp" method="post" id="signupForm">
				...
				<div>
					...
					<input
						...
						class="form-control" type="text" name="email" id="email" placeholder="aaa@bbb.com" />
					<div class="invalid-feedback">이메일 형식에 맞게 입력하세요</div>
				</div>
				<br>
				<button v-bind:disabled="!isFormValid" class="btn btn-primary submit_Btn" type="submit">가입</button>
			</form>
		</div>
	</div>
